...
export default function WakafPage() {
  ...
  // Handler saat tombol Wakaf Sekarang diklik
  ...
  // Helper format input rupiah (lokal untuk input field)
      ...
      {isModalOpen && selectedDonation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="bg-success text-white p-4 flex items-center justify-between sticky top-0 z-10">
              <h3 className="font-bold font-comfortaa text-lg truncate pr-4">
                Wakaf: {selectedDonation.title}
              </h3>
              <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="text-lg font-bold text-success border-awqaf-border-light focus-visible:ring-success"
                />
                <div className="flex gap-2 mt-2 overflow-x-auto pb-1 scrollbar-hide">
                  {["100.000", "500.000", "1.000.000"].map((amt) => (
                    <button
                      key={amt}
                      onClick={() => setDonationAmount(amt)}
                      className="px-3 py-1 text-xs bg-green-50 text-success rounded-full border border-green-100 hover:bg-green-100 transition-colors whitespace-nowrap"
                    >
                      Rp {amt}
                    </button>
                  ))}
                ...
                {paymentMethod === "qris" ? (
                  <div className="space-y-3">
                    <div className="w-48 h-48 bg-white mx-auto p-2 rounded-lg shadow-sm border border-gray-200 flex items-center justify-center relative">
                      {/* QR Code */}
                      <Image
                        src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=Wakaf%20${encodeURIComponent(
                  ...
                  <div className="w-full space-y-4">
                    ...
                    <div className="bg-white p-3 rounded-lg border border-gray-200 shadow-sm relative">
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-lg font-mono font-bold text-success tracking-wider">
                          7778889990
                        </p>
                        <button
                          onClick={() => handleCopy("7778889990")}
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50 sticky bottom-0 z-10">
              <Button className="w-full bg-success hover:bg-success/90 text-white font-bold font-comfortaa">
                Konfirmasi Wakaf
              </Button>
            </div>
          </div>
